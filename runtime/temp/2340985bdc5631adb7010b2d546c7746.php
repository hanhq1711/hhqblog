<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"E:\phpStudy\WWW\hblog\public/../application/admin\view\Public\index.html";i:1491291164;s:73:"E:\phpStudy\WWW\hblog\public/../application/admin\view\public\header.html";i:1491291164;s:73:"E:\phpStudy\WWW\hblog\public/../application/admin\view\public\footer.html";i:1491291164;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="/admin/config/group.html">网站配置</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/admin/article/index_cate.html">文章分类</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<?php echo url('Article/add_article'); ?>">文章列表</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
