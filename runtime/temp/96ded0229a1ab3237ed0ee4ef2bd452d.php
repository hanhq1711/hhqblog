<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/yjdata/www/hhqblog/public/../application/admin/view/public/index.html";i:1493465479;s:71:"/yjdata/www/hhqblog/public/../application/admin/view/public/header.html";i:1493465479;s:71:"/yjdata/www/hhqblog/public/../application/admin/view/public/footer.html";i:1493465479;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" width="70px" height="70px" src="" onerror="this.src='/static/admin/images/a3.jpg'"/></span>
                ...
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/admin/user/index.html">用户管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/admin/role/index.html">角色管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/admin/menu/index.html">菜单管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/admin/config/index.html">配置管理</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="<?php echo url('Sys/index'); ?>">系统设置</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/admin/user/index.html">菜单列表</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/admin/data/import.html">数据库还原</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/admin/data/index.html">数据库备份</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/admin/member/group.html">会员组</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/admin/member/index.html">会员列表</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('Article/index'); ?>">文章列表</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?php echo url('Category/index'); ?>">分类列表</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/admin/ad/index_position.html">广告位</a>
                        </li>
                        <li>
                            <a class="J_menuItem" href="/admin/ad/index.html">广告列表</a>
                        </li>
                    </ul>
                </li>
                <li class="menu">
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="/admin/log/operate_log.html">行为日志</a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?php echo url('Index/main'); ?>" frameborder="0" data-id="index.html" seamless></iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2016-2017 韩会强博客后台管理 版权所有
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
...
$(function(){
    $("#cache").click(function(){
        layer.confirm('你确定要清除缓存吗？', {icon: 3, title:'提示'}, function(index){                   
            $.getJSON("<?php echo url('admin/Sys/clear'); ?>",function(res){
                if(res.code == 1){
