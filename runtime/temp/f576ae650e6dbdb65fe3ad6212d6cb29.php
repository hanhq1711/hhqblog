<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"E:\phpStudy\WWW\hblog\public/../application/admin\view\index\index.html";i:1491291164;s:73:"E:\phpStudy\WWW\hblog\public/../application/admin\view\public\header.html";i:1491291164;s:73:"E:\phpStudy\WWW\hblog\public/../application/admin\view\public\footer.html";i:1491291164;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <p><i class="fa fa-send-o"></i> 博客：<a href="<?php echo config('webinfo.weburl'); ?>" target="_blank"><?php echo config('webinfo.weburl'); ?></a>
                        </p>
                        <p><i class="fa fa-qq"></i> QQ：<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo config('webinfo.weburl'); ?>&amp;site=qq&amp;menu=yes" target="_blank"><?php echo config('webinfo.webqq'); ?></a>
                        </p>
                        <p><i class="fa fa-weixin"></i> 微信：<a href="javascript:;"><?php echo config('webinfo.webwechat'); ?></a>
                        </p>
                        <p><i class="fa fa-credit-card"></i> 支付宝：<a href="javascript:;" class="支付宝信息"><?php echo config('webinfo.webali'); ?></a>
                        </p>
                    </div>
                </div>
            </div>
